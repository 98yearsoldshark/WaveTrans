...
![[Image/Pasted image 20240821163625.png]]
...
![[Image/Pasted image 20240821163633.png]]

打开step2/Step2：微调.ipynb 文件

![[Image/Pasted image 20240821163644.png]]

点击“运行所有单元格”

![[Image/Pasted image 20240821163653.png]]
...
![[Image/Pasted image 20240821163702.png]]
...
![[Image/Pasted image 20240821163747.png]]
...
![[Image/Pasted image 20240821163811.png]]

我们使用 `pandas` 进行数据读取，然后转成 `Dataset` 格式：

![[Image/Pasted image 20240821163818.png]]

然后我们需要加载 tokenizer:

![[Image/Pasted image 20240821163825.png]]
...
![[Image/Pasted image 20240821163949.png]]

然后构建一个 `PeftModel`:

![[Image/Pasted image 20240821163956.png]]

通过 `model.print_trainable_parameters()`，可以看到需要训练的参数在所有参数中的占比：

![[Image/Pasted image 20240821164005.png]]
...
![[Image/Pasted image 20240821170828.png]]

同时初始化一个 `Trainer`:

![[Image/Pasted image 20240821170835.png]]

最后运行 `trainer.train()` 执行模型训练。

![[Image/Pasted image 20240821170844.png]]

在训练过程中，会打印模型训练的loss，我们可以通过loss的降低情况，检查模型是否收敛：

![[Image/Pasted image 20240821170850.png]]

![[Image/Pasted image 20240821170854.png]]

![[Image/Pasted image 20240821170900.png]]

同时，我们会看到左侧 `output` 文件夹下出现了3个文件夹，每个文件夹下保存着每个epoch训完的模型。

![[Image/Pasted image 20240821170909.png]]

这里，以epoch3为例，可以看到其中保存了训练的config、state、ckpt等信息。

![[Image/Pasted image 20240821170916.png]]

### **5 效果验证**

完成模型训练后，我们通过定义一个生成函数 `generate()`，来进行效果验证：

![[Image/Pasted image 20240821170936.png]]

同时定义好输入的prompt template，这个要和训练保持一致。

![[Image/Pasted image 20240821170945.png]]

最后，我们输入样例进行测试：

![[Image/Pasted image 20240821170952.png]]
...
![[Image/Pasted image 20240821171006.png]]
...
![[Image/Pasted image 20240821171016.png]]
...
![[Image/Pasted image 20240821171024.png]]
